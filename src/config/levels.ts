...
export const LEVELS: LevelConfig[] = [
  ...
  },
  {
    ...
    hazards: [
      ...
      { type: "steam", x: 625, y: 295, direction: "up", length: 120, width: 40, offMs: 3200, warnMs: 700, activeMs: 1000 },
    ],
  ...
  },
  {
    ...
    hazards: [
      ...
      { type: "steam", x: 780, y: 415, direction: "up", length: 120, width: 40, offMs: 3000, warnMs: 700, activeMs: 1100 },
  ...
  },
  {
    ...
    hazards: [
      ...
      { type: "steam", x: 625, y: 490, direction: "up", length: 120, width: 40, offMs: 3400, warnMs: 900, activeMs: 900 },
      { type: "electric", x: 800, y: 140, w: 100, h: 18, offMs: 3500, warnMs: 1100, activeMs: 900 },
      { type: "steam", x: 530, y: 320, direction: "left", length: 100, width: 30, offMs: 3500, warnMs: 1000, activeMs: 900 },
    ],
    overclockPerSecond: 1.6,
    serverHeatBase: 1.7,
    serverHeatFactor: 1.2,
  ...
  },
  {
    ...
    drain: { x: 135, y: 495 },
    hazards: [
      { type: "electric", x: 785, y: 430, w: 130, h: 22, offMs: 3400, warnMs: 900, activeMs: 900 },
      { type: "steam", x: 340, y: 500, direction: "up", length: 120, width: 40, offMs: 3500, warnMs: 900, activeMs: 900 },
      { type: "electric", x: 800, y: 140, w: 100, h: 18, offMs: 3700, warnMs: 1100, activeMs: 900 },
      { type: "steam", x: 275, y: 320, direction: "left", length: 100, width: 30, offMs: 3700, warnMs: 1000, activeMs: 900 },
      { type: "electric", x: 480, y: 90, w: 120, h: 18, offMs: 4000, warnMs: 1100, activeMs: 900 },
    ],
  ...
  },
  {
    ...
    platforms: [
      ...
      { x: 180, y: 440, w: 160, h: 18 },
      { x: 780, y: 440, w: 160, h: 18 },
      { x: 180, y: 320, w: 160, h: 18 },
      { x: 785, y: 320, w: 160, h: 18 },
      { x: 475, y: 320, w: 200, h: 18 },
      { x: 800, y: 150, w: 120, h: 18 },
      { x: 200, y: 150, w: 120, h: 18 },
      { x: 485, y: 150, w: 200, h: 18 },
      { x: 945, y: 70, w: 100, h: 18 },
    ],
    servers: [
      { x: 165, y: 260 },
      { x: 785, y: 260 },
    ...
    hazards: [
      ...
      { type: "steam", x: 240, y: 315, direction: "up", length: 120, width: 40, offMs: 4000, warnMs: 1100, activeMs: 900 },
      { type: "electric", x: 785, y: 425, w: 100, h: 18, offMs: 4200, warnMs: 1200, activeMs: 900 },
      { type: "steam", x: 705, y: 320, direction: "left", length: 100, width: 30, offMs: 4200, warnMs: 1200, activeMs: 900 },
      { type: "electric", x: 475, y: 300, w: 120, h: 18, offMs: 4500, warnMs: 1200, activeMs: 900 },
      { type: "steam", x: 395, y: 340, direction: "down", length: 80, width: 30, offMs: 4500, warnMs: 1200, activeMs: 900 },
    ],
